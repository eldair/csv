...
use Closure;
use Deprecated;
use Eldair\Csv\Serializer\Denormalizer;
use Eldair\Csv\Serializer\MappingFailed;
use Eldair\Csv\Serializer\TypeCastingFailed;
use Iterator;
...
class Reader extends AbstractCsv implements TabularDataReader, JsonSerializable
{
    ...
    /** @var callable */
    protected $header_formatter = null;
    ...
    /**
     * @param \Eldair\Csv\Query\Predicate|Closure(array, array-key): bool $predicate
     *
     * @throws Exception
     * @throws SyntaxError
     */
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\Resultset::fetchColumn() instead', since: 'league/csv:9.23.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message: 'use Eldair\Csv\Reader::nth() instead', since: 'league/csv:9.9.0')]
     ...
     * @throws TypeCastingFailed
     */
    #[Deprecated(message: 'use Eldair\Csv\Reader::getRecordsAsObject() instead', since: 'league/csv:9.15.0')]
