...
abstract class AbstractCsv implements ByteSequence
{
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\AbstractCsv::supportsStreamFilterOnRead() or Eldair\Csv\AbstractCsv::supportsStreamFilterOnWrite() instead', since: 'league/csv:9.7.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message: 'use Eldair\Csv\AbstractCsv::toString() instead', since: 'league/csv:9.7.0')]
     ...
     * Retrieves the CSV content
     */
    #[Deprecated(message: 'use Eldair\Csv\AbstractCsv::toString() instead', since: 'league/csv:9.1.0')]
     ...
     */
    #[Deprecated(message: 'the method no longer affect the outcome of the class, use Eldair\Csv\HttpHeaders::forFileDownload instead', since: 'league/csv:9.17.0')]
     ...
     * @throws Exception
     */
    #[Deprecated(message: 'use Eldair\Csv\AbstractCsv::download() instead', since: 'league/csv:9.18.0')]
     ...
     * @throws UnavailableFeature If the stream filter API can not be used
     */
    #[Deprecated(message: 'use Eldair\Csv\AbstractCsv::appendStreamFilterOnRead() or Eldair\Csv\AbstractCsv::prependStreamFilterOnRead() instead', since: 'league/csv:9.18.0')]
