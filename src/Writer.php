...
class Writer extends AbstractCsv implements TabularDataWriter
{
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\Writer::getEndOfLine()', since: 'league/csv:9.10.0')]
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\Writer::setEndOfLine()', since: 'league/csv:9.10.0')]
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\Writer::necessaryEnclosure()', since: 'league/csv:9.22.0')]
