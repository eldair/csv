...
class CharsetConverter extends php_user_filter
{
     ...
     * @return resource
     */
    #[Deprecated(message: 'use Eldair\Csv\CharserConverter::appendOnReadTo() or Eldair\Csv\CharserConverter::appendOnWriteTo() instead', since: 'league/csv:9.22.0')]
     ...
     * @return resource
     */
    #[Deprecated(message: 'use Eldair\Csv\CharserConverter::prependOnReadTo() or Eldair\Csv\CharserConverter::prependOnWriteTo() instead', since: 'league/csv:9.22.0')]
