...
class XMLConverter
{
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\XMLConverter::impoprt()', since: 'league/csv:9.22.0')]
     ...
     */
    #[Deprecated(message: 'use Eldair\Csv\XMLConverter::__construct()', since: 'league/csv:9.22.0')]
