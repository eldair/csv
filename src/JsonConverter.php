...
final class JsonConverter
{
     ...
     * @param int<1, max> $indentSize
     */
    #[Deprecated(message: 'use Eldair\Csv\JsonConverter::withPrettyPrint() instead', since: 'league/csv:9.19.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message: 'use Eldair\Csv\JsonConverter::__construct() instead', since: 'league/csv:9.22.0')]
