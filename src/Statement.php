...
class Statement
{
     ...
     */
    #[Deprecated(message: 'this method no longer affects on the outcome of the class, use Eldair\Csv\Statement::process() instead', since: 'league/csv:9.16.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message: 'this method no longer affects on the outcome of the class, use Eldair\Csv\Statement::applyFilter() instead', since: 'league/csv:9.15.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message: 'use Eldair\Csv\Statement::__construct() instead', since: 'league/csv:9.22.0')]
