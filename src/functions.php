 ...
 */
#[Deprecated(message: 'use Eldair\Csv\Bom::tryFromSequence()', since: 'league/csv:9.7.0')]
 ...
 */
#[Deprecated(message: 'use Eldair\Csv\Info::getDelimiterStats() instead', since: 'league/csv:9.8.0')]
